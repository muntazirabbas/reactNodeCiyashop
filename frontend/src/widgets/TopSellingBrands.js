...
import MyProducts from '../api/topBrand.json'
class TopSellingBrands extends Component {
    state = {  }
    rating(productrat)
{
   let rat=[];
   ...
   return rat;
    ...
    render() { 
        return ( <Row className="products products-loop grid ciyashop-products-shortcode">
            ...
            <div className="product-inner element-hovered">
               ...
               <div className="product-info">
                  ...
                  <h3 className="product-name ">
                     <Link className="font-weight-bold" to={`/shop/${product.category}/${product.id}`}>{product.name} </Link>
                  </h3>
